  ...
  return (
    <GlassCard interactive={false} className="border-white/10 overflow-hidden shadow-xl rounded-[2rem]">
        <div className="p-4 sm:p-6 md:p-8">
            ...
            <p className="text-gray-200 mb-6 text-base sm:text-lg font-medium leading-relaxed tracking-tight whitespace-pre-wrap">{post.content}</p>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-white/5">
                <div className="flex items-center gap-2">
                    <button 
                      ...
                      className={cn(
                        "flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full transition-all duration-300 font-bold text-[10px] sm:text-xs uppercase tracking-widest",
                        isLiked ? "bg-primary/20 text-primary" : "bg-white/5 text-gray-400 hover:bg-white/10"
                      )}>
                      <ThumbsUp className={cn("w-3.5 h-3.5 sm:w-4 sm:h-4", isLiked && "fill-current")}/>
                      <span>{likeCount}</span>
                    </button>
...
function CommunityPageContent() {
  ...
  return (
    <div className="h-full flex flex-col bg-background/50">
      <header className="border-b border-white/10 p-4 md:px-10 flex items-center justify-between backdrop-blur-md sticky top-0 z-50">
      ...
      <main className="flex-1 overflow-auto bg-gradient-to-b from-transparent to-primary/5">
        <div className="max-w-4xl mx-auto py-12 px-4 md:px-8">
            ...
            >
                <div>
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-black italic tracking-tighter text-white mb-2">Community Feed</h1>
                    <p className="text-[10px] text-muted-foreground font-black uppercase tracking-[0.3em]">Connect & Soul Search</p>
                </div>
                <Button 
                    onClick={() => setIsCreatePostOpen(!isCreatePostOpen)}
                    className="rounded-full bg-primary hover:bg-primary/90 text-white font-black italic px-8 h-12 shadow-lg shadow-primary/25 transition-all active:scale-95 w-full sm:w-auto"
                >
                        ...
                        <div className="p-5 sm:p-8">
                            <form onSubmit={handleCreatePost}>
                                <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                                    <Avatar className="w-12 h-12 sm:w-14 sm:h-14 border-2 border-primary/20 mt-1 shrink-0">
                                        <AvatarFallback className="bg-primary/10"><User className="w-6 h-6"/></AvatarFallback>
                                    </Avatar>
                                    <div className="flex-1 space-y-6">
                                        <Textarea 
                                            className="w-full bg-transparent text-lg sm:text-xl font-medium placeholder:text-muted-foreground/40 border-none focus-visible:ring-0 resize-none min-h-[100px] sm:min-h-[120px] p-0" 
                                        ...
                                        <div className="flex flex-col sm:flex-row justify-between items-center pt-6 border-t border-white/5 gap-6">
                                            ...
                                            <div className="flex items-center gap-3 w-full sm:w-auto">
                                                <Button 
                                                    ...
                                                    className="flex-1 sm:flex-none rounded-full px-6 font-black italic text-[10px] sm:text-xs uppercase tracking-widest"
                                                >
                                                    Cancel
                                                </Button>
                                                <Button 
                                                    ...
                                                    className="flex-1 sm:flex-none rounded-full bg-primary px-8 sm:px-10 h-11 font-black italic uppercase tracking-widest text-[10px] sm:text-xs"
                                                >
